...
@fixtures.parameterize(
    "strings",
    [
        ("8.8.8.8"),  # Valid IPv4 addresses from here on down
        ("128.0.0.1"),
        ("123.4.56.78"),
        ("0.0.0.0"),
        ("255.255.255.255"),
        ("255.255.255.256"),  # Invalid IPv4 addresses from here on down
        ("255.255.255.-1"),
        ("2555.255.255.255"),
        ("2001:0db8:85a3:0000:0000:8a2e:0370:7334"),  # Valid IPv6 addresses from here on down
        ...
        ("0:0:0:0:0:0:0:0"),  # Invalid IPv6 addresses from here on down
